...
function Navbar() {
    ...
    return (
        <>
            <div className={`'max-w-screen-2xl container mx-auto md:px-20 px-4  dark:bg-slate-900 dark:text-white fixed top-0 left- right-0 z-50 ${sticky ? "sticky-navbar shadow-md bg-base-200 dark:bg-slate-900 dark:text-white duration-300 transition-all ease-in-out" : ""}`}>

                <div className="navbar ">
                    <div className="navbar-start ">
                        <div className="dropdown dark:text-blue-800 ">
                    ...
                    <div className="navbar-end space-x-3">
                        ...
                        <div className="" >
                            <label className="swap swap-rotate">
                                ...
                                <input type="checkbox" className="theme-controller" value="synthwave" onClick={() => setTheme(theme === "light" ? "dark" : "light")} />
